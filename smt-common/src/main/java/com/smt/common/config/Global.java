...
public class Global
{
    ...
    {
        return StringUtils.nvl(getConfig("smt.name"), "smt");
    }
    ...
    {
        return StringUtils.nvl(getConfig("smt.version"), "3.2.0");
    }
    ...
    {
        return StringUtils.nvl(getConfig("smt.copyrightYear"), "2018");
    }
    ...
    {
        return Boolean.valueOf(getConfig("smt.addressEnabled"));
    }
    ...
    {
        return getConfig("smt.profile") + "avatar/";
    }
    ...
    {
        return getConfig("smt.profile") + "download/";
    }
    ...
    {
        return getConfig("smt.profile") + "upload/";
    }
    ...
    {
        return StringUtils.nvl(getConfig("gen.author"), "smt");
    }
    ...
    {
        return StringUtils.nvl(getConfig("gen.packageName"), "com.smt.project.module");
    }
